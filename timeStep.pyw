...
def printout(res):
    ...
    for ii, r in enumerate(labels):
        tk.Label(frame01, text=r, bg="white", width=11, font=f_H12B, anchor='center', borderwidth=2,
                 relief="groove").grid(row=ii, column=1, padx=1)
...
for i, var in enumerate(VarList):
    ...
    tk.Frame(frame01, height=32, width=125, colormap="new", relief="sunken", bd=2).grid(row=i, column=1, sticky="E",
                                                                                        padx=12, pady=11)
